...
public class UserController {
   ...
   @ResponseBody
   public String sign_up(@RequestBody String payload, HttpServletResponse response) {
      HttpHeaders resHeaders = new HttpHeaders();
      resHeaders.add("Content-Type", "application/json;charset=UTF-8");

      Cookie myCookie = new Cookie("AirdndSES", "cook");
   ...
   @ResponseBody
   public String sign_in(@RequestBody String payload, HttpServletRequest request, HttpServletResponse response) {
      HttpHeaders resHeaders = new HttpHeaders();
      resHeaders.add("Content-Type", "application/json;charset=UTF-8");
   ...
   @ResponseBody
   public String sign_out(Model model, @RequestBody String payload, HttpServletRequest request, HttpServletResponse response) {
      HttpHeaders resHeaders = new HttpHeaders();
      resHeaders.add("Content-Type", "application/json;charset=UTF-8");
